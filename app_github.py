...
def apply_editor_changes(original_df: pd.DataFrame, editor_state: dict, default_book: str = "미자"):
...
book_filter = st.sidebar.radio("Book", ["미자", "BTB"], label_visibility="collapsed")
...
if page == "다가오는 Reset":
    ...
    new_edited_df = st.data_editor(
        ...
        column_config={
            ...
            "book": st.column_config.SelectboxColumn("Book", options=["미자", "BTB"]),
